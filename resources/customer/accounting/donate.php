                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <?php if(!is_null($user->getDataById($userid,'projectlogo'))){ ?>
                                <img src="<?= $user->getDataById($userid,'projectlogo'); ?>" width="auto">
                            <?php } ?>
                            ...
                            <?php if(is_null($user->getDataById($userid,'projectname'))){ ?>
                                <br>
                                <br>
                                <h1>Hier könnte ein Projektname stehen</h1>
                            <?php } ?>
                        ...
                        <div class="card-body">
                            ...
                            <form method="post">
                                ...
                                <center>
                                    <font size="2">
                                        <p>
                                        <b>Hinweis:</b> Guthaben kann nicht ausgezahlt oder erstattet werden.
                                        </p>
                                    </font>
                                </center>
                            </form>
