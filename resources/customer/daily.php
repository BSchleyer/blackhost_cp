	...
	Du hast deine Belohnung für heute bereits gesammelt.
            ...
            <?php } ?>
			 ...
			 <?php if($SQL->rowCount() == 0){ ?>
                                ...
                                <button type="submit" name="claimDaily" class="btn btn-outline-primary btn-block">
                    ...
                    <div class="card card-custom card-stretch gutter-b shadow mb-5">
                        <div class="card-body d-flex flex-column">
                            ...
                            <?php } ?>
                                            ...
                                            <td><a class="btn btn-outline-primary btn-sm font-weight-bolder" href="tickets" target="_blank">Fehler melden</a> 
											</td>
                                        </tr>
                                    <?php } } ?>
                                </tbody>
