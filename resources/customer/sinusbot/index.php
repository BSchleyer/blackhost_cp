    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <div class="row">
                ...
                <?php
                $SQL = $db->prepare("SELECT * FROM `sinusbots` WHERE `user_id` = :user_id AND `deleted_at` IS NULL ORDER BY `id` DESC");
                                ...
                                <div class="card-footer">
                                    <div class="row align-items-center text-center">
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <a href="<?= env('URL'); ?>manage/sinusbot/<?= $row['id']; ?>" class="btn btn-block btn-outline-primary">
                                                    <b>Verwalten</b>
                                                </a>
                                            <?php } ?>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <a href="<?= env('URL'); ?>renew/sinusbot/<?= $row['id']; ?>" class="btn btn-block btn-outline-primary">
                                                    <b>Verlängern</b>
                                                </a>
                                            <?php } ?>
                                        </div>
