<?php
$currPage = 'back_SinusBot verwalten';
include BASE_PATH.'app/controller/PageController.php';
include BASE_PATH.'app/manager/customer/sinusbot/manage.php';
?>
                    ...
                    <div class="card shadow mb-5">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p class="text-muted mb-2 font-13">
                                        <span class="ml-2">SinusBot Instanz#<?= $serverInfos['id']; ?></span>
                                    </p>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <p class="text-muted mb-2 font-13">
                                        <span class="ml-2">
                                            <span class="noselect" id="sinusbot_password">************</span>
                                            <span style="cursor: pointer;" id="sinusbot_icon" onclick="passwordEye('sinusbot');">
                                                <i class="far fa-eye"></i>
                                            </span>

                                            <i style="cursor: pointer;" class="fas fa-copy copy-btn" data-clipboard-text="<?= $serverInfos['sb_password']; ?>" data-toggle="tooltip" title="Passwort kopieren"></i>
                                        </span>
                                    </p>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="mt-5"></div>
                                    <a class="btn btn-block btn-outline-warning" href="<?= $helper->url(); ?>renew/sinusbot/<?= $id; ?>"><i class="fas fa-history"></i> <b>Verlängern</b></a>
...
<script>
    ...
    function passwordEye(type) {
        ...
        if(type == 'sinusbot'){
            if(sinusbot){
                $('#sinusbot_password').html("<?= $serverInfos['sb_password']; ?>");
                $('#sinusbot_icon').html('<i class="far fa-eye-slash"></i>');
                sinusbot = false;
            } else {
                $('#sinusbot_password').html('************');
                $('#sinusbot_icon').html('<i class="far fa-eye"></i>');
                sinusbot = true;
            }
        }
    }
