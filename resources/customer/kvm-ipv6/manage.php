<?php
$currPage = 'back_IPv6 KVM Verwaltung';
include BASE_PATH.'app/controller/PageController.php';

$siteid = $helper->protect($_GET['id']);

                $SQL = $db->prepare("SELECT * FROM `kvm_ipv6` WHERE `vt_ownerid` = :user_id AND `id` = :siteid AND `state` = 'active'");
                    ...
                    <div class="card shadow mb-5">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p class="text-muted mb-2 font-13">
                                        <span class="ml-2"><?= $row['kvm_speicher']; ?> GB HDD</span>  
                                    </p>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="card shadow mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <a class="btn btn-block btn-outline-success" href="<?= $helper->url(); ?>renew/kvm-ipv6/<?= $siteid; ?>">
