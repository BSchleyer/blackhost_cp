    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <div class="row">
                ...
                <?php
                $SQL = $db->prepare("SELECT * FROM `kvm_ipv6` WHERE `vt_ownerid` = :user_id AND `deleted_at` IS NULL ORDER BY `id` DESC");
                        ...
                        <div class="col-12 col-xl-3">
                            <div class="card text-center shadow mb-5">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <a href="<?= env('URL'); ?>manage/kvm-ipv6/<?= $row['id']; ?>" class="btn btn-block btn-outline-warning">
                                        ...
                                        <div class="col-md-6">
                                            <a href="<?= env('URL'); ?>renew/kvm-ipv6/<?= $row['id']; ?>" class="btn btn-block btn-outline-success">
