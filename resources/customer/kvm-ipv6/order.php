<?php
$currPage = 'front_IPv6 KVM Bestellen';
include BASE_PATH.'app/controller/PageController.php';
    include BASE_PATH.'app/manager/customer/kvm-ipv6/order.php';

    // rabatt [START]
    $SQL50 = $db->prepare("SELECT * from `produkt_rabatt` WHERE `produkt` = 'ipv6'");
    $SQL50->execute();
...
?>
					...
					$order = true;
                                    ...
                                    $SQL2->execute(array(":option_id" => '50'));
                                    ...
                                    $SQL4->execute(array(":option_id" => '51'));
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="text-center" style="margin-top: 1px; margin-bottom: 30px;">
            <h1 style="font-size: 70px;">Unsere <b style="color: <?= env('MAIN_COLOR'); ?>">IPv6</b> Server</h1>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="card" style="border-radius: 15px 10px;">
                        <div class="card-header"><h1>Deutschland, IPv6 KVM Server</h1>
...
<div class="alert alert-success col-md-12" role="alert">
    ...
    sowie die Verlängerung
       ...
       <?php } ?>
                    ...
                    <div class="alert alert-primary col-md-12" role="alert">
				    Aktuell sind <b>0</b> IPv4 Adressen kostenfrei aufschaltbar.
			        </div>

                    <div class="alert alert-primary col-md-12" role="alert">
				    Aktuell sind <b>6</b> IPv4 Adressen, für einmalig 25.00€, aufschaltbar.
			        </div>
                    ...
                    <?php } ?>
						...
						<hr>
							...
							<i class="fa fa-microchip" style="color: <?= env('MAIN_COLOR'); ?>"></i>
							  </span> bis zu <b>32</b> Intel Xeon vKerne (Basistakt: 3.5 GHz)
							<br>
                        ...
                        <div class="card-body">
                            <form method="post" id="orderForm">
                                ...
                                <select class="form-control" id="cores" name="cores">
                                    ...
                                    $SQL->execute(array(":option_id" => '53'));
                                ...
                                <select class="form-control" id="ipv4" name="ipv4">
                                    <?php
                                    $SQL = $db->prepare("SELECT * FROM `product_option_entries` WHERE `option_id` = :option_id");
                                    $SQL->execute(array(":option_id" => '50'));
                                    if ($SQL->rowCount() != 0) { while ($row = $SQL->fetch(PDO::FETCH_ASSOC)) { ?>
									<?php include 'option.php'; ?>
                                    <?php } } ?>
                                </select>
                                ...
                                <span class="badge badge-primary">Ubuntu empfohlen</span>
                                ...
                                <select class="form-control" name="ddos-protection">
                                    <option data-price="0.00" value="0.00">Deutschland (+ 0.00€)</option>
                                </select>
                ...
                <script>
                    ...
                    function update()
                    {
                        sum = parseFloat($("#cores").find("option:selected").data("price"))
                            ...
                            +parseFloat($("#ipv6").find("option:selected").data("price"))
