...
$siteid = $helper->protect($_GET['id']);
                ...
                $SQL = $db->prepare("SELECT * FROM `kvm_server` WHERE `vt_ownerid` = :user_id AND `id` = :siteid AND `state` = 'active'");
                    ...
                    <div class="card shadow mb-5">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p class="text-muted mb-2 font-13">
                                        <span class="ml-2"><a href="<?= env('KVM_URL'); ?>" target="_blank"><?= env('KVM_URL'); ?></a></span>
                                    </p>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <p class="text-muted mb-2 font-13">
                                        <span class="ml-2"><?= $row['vt_host']; ?></span>  
                                    </p>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <p class="text-muted mb-2 font-13">
                                        <span class="ml-2"><?= $row['kvm_ram']; ?> MB DDR4 RAM</span>  
                                    </p>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <p class="text-muted mb-2 font-13">
                                        <span class="ml-2"><?= $row['kvm_ip']; ?> IPv4 enthalten</span>  
                                    </p>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="card shadow mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-block btn-outline-primary" href="<?= env('KVM_URL'); ?>" target="_blank">
