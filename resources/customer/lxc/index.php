                        ...
                        <div class="col-md-12">
                            ...
                            <?php } ?>
                                <h1 class="alert-heading">
                                    <br>
                                    Du besitzt aktuell keinen KVM-Server😱
                                </h1>
                                <br>
                                <p>
                                    <a href="<?= env('URL'); ?>order/kvm" class="btn btn-outline-primary text-uppercase font-weight-bolder pulse-red">Jetzt bestellen</a>
                                </p>
                            </div>
                        </div>
                    <?php } ?>
