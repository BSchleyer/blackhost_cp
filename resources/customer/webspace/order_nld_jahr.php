<?php
$currPage = 'front_Webspace DE/JAHR Bestellen';
include BASE_PATH.'app/controller/PageController.php';
include BASE_PATH.'app/manager/customer/webspace/order_jahr.php';
?>
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">

        <div class="text-center" style="margin-top: 50px; margin-bottom: 50px;">
            <h1 style="font-size: 70px;">Unsere <b style="color: #6254FE;">Plesk</b> Webserver</h1>
        </div>
...
//                                    $names = ['disc', 'domains', 'subdomains', 'databases', 'ftp_accounts', 'emails'];
                                ...
                                $SQL = $db->prepare("SELECT * FROM `webspace_packs` WHERE `kat` = '2'");
                                $SQL->execute();
                                if ($SQL->rowCount() != 0) {
                ...
                <div class="col-md-4">
                    <div class="card shadow mb-5">
                        <div class="card-header text-center">
                            ...
                            <b><span style="font-size: 28px;"><?= $row['price']; ?>€</span> / 365 Tage</b>

                            <?php } elseif($row['price_old'] !== 0) { ?>
                            <b><span style="font-size: 28px; color:red;"><?= $row['price']; ?>€</span>/ 365 Tage</b>
								<br>
