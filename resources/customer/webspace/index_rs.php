<?php
$currPage = 'back_Webspace Reseller';
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <div class="row">
                ...
                <?php
                $SQL = $db->prepare("SELECT * FROM `webspace_rs` WHERE `user_id` = :user_id AND `deleted_at` IS NULL ORDER BY `id` DESC");
                        ...
                        <div class="col-12 col-xl-3">
                            <div class="card text-center shadow mb-5">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h4 class="mb-lg-4">
                                                ...
                                                <span class="badge badge-success"><?= $row['rs_name']; ?></span>
                                            </h4>
                                        </div>
                                    </div>
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <a href="<?= env('URL'); ?>manage/reseller/webspace/<?= $row['id']; ?>" class="btn btn-block btn-outline-warning">
                                        ...
                                        <div class="col-md-6">
                                            <a href="<?= env('URL'); ?>renew/reseller/webspace/<?= $row['id']; ?>" class="btn btn-block btn-outline-success">
