<?php
$currPage = 'back_Nextcloud verwalten';
include BASE_PATH.'app/controller/PageController.php';

$siteid = $helper->protect($_GET['id']);

                $SQL = $db->prepare("SELECT * FROM `cloudserver` WHERE `user_id` = :user_id AND `id` = :siteid AND `state` = 'active'");
                    ...
                    <div class="card shadow mb-5">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p class="text-muted mb-2 font-13">
                                        <span class="ml-2"><a href="<?= $row['nc_url']; ?>" target="_blank"><?= $row['nc_url']; ?></a></span>
                                    </p>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <p class="text-muted mb-2 font-13">
                                        <span class="ml-2"><?= $row['nc_speicher']; ?></span>  
                                    </p>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <p class="text-muted mb-2 font-13">
                                        <strong>Cloud Benutzername:</strong>
                                    </p>
                                </div>
                                
                                <div class="col-md-6">
                                    <p class="text-muted mb-2 font-13">
                                        <span class="ml-2"><?= $row['nc_username']; ?></span>
                                    </p>
                                </div>
                                
                                <div class="col-md-6">
                                    <p class="text-muted mb-2 font-13">
                                        <strong>Cloud Passwort:</strong>  
                                    </p>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <p class="text-muted mb-2 font-13">
                                        <span class="ml-2">
                                            ...
                                            <i style="cursor: pointer;" class="fas fa-copy copy-btn" data-clipboard-text="<?= $row['nc_pass']; ?>" data-toggle="tooltip" title="Passwort kopieren"></i>
                                        </span>
                                    </p>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="card shadow mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-block btn-outline-primary" href="<?= $row['nc_url']; ?>" target="_blank">
								<b><i class="fas fa-sign-in-alt"></i> Zum Cloud Login</b>
							</a>

                            <br>
                            <a class="btn btn-block btn-outline-success" href="<?= $helper->url(); ?>renew/nextcloud/<?= $siteid; ?>">
...
<script>
    ...
    function passwordEye(type) {
        if(type == 'plesk'){
            if(plesk){
                $('#plesk_password').html("<?= $row['nc_pass']; ?>");
