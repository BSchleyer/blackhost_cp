    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <div class="row">
                ...
                <?php
                $SQL = $db->prepare("SELECT * FROM `cloudserver` WHERE `user_id` = :user_id AND `deleted_at` IS NULL ORDER BY `id` DESC");
                            ...
                            <div class="card text-center shadow mb-5">
                                    ...
                                    <div class="row align-items-center text-center">
                                        <div class="col">
                                            ...
                                            <span class="svg-icon svg-icon-primary svg-icon-8x">
												<i class="fa fa-cloud" style="color:#6254FE"></i>
												</span>
												<br><br>

                                                    <b>Nextcloud</b> #<?= $row['id']; ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h4 class="mb-lg-4">
                                                <b>Verfüg. Speicher</b><br>
                                                <span class="badge badge-success"><?= $row['nc_speicher']; ?> SSD NVMe</span>
                                            </h4>
                                        </div>
                                    </div>
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <a href="<?= env('URL'); ?>manage/nextcloud/<?= $row['id']; ?>" class="btn btn-block btn-outline-warning">
                                        ...
                                        <div class="col-md-6">
                                            <a href="<?= env('URL'); ?>renew/nextcloud/<?= $row['id']; ?>" class="btn btn-block btn-outline-success">
