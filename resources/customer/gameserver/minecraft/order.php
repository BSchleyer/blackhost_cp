...
include BASE_PATH . 'app/manager/customer/gameserver/minecraft/order.php';
include BASE_PATH . 'app/manager/customer/gameserver/minecraft/order_reseller.php';
$reseller = false;
            ...
            <div class="row">
                    ...
                    <div class="card" style="border-radius: 15px 10px;">
                        <div class="card-header"><h1>Deutschland, Minecraft Gameserver</h1>
                            ...
                            <?php if ($mainrabatt > 0) { ?>
                                ...
                                <div class="alert alert-success col-md-12" role="alert">
                                    Bestelle innerhalb von <b><span id="countdown"></span></b> und spare
                                    <b><?= $mainrabatt; ?>%</b> auf deine Bestellung,
                            ...
                            <?php if ($order == false) { ?>
                                <div class="alert alert-primary col-md-12" role="alert">
                                    Sehr geehrter Kunde, leider ist die Bestellung über den Konfigurator nicht möglich,
                                    da die verfügbaren
                                    Hostsysteme nicht über genug Leistung verfügung. Unser Team ist bereits informiert
                                    und wir arbeiten an einer Lösung.
                                </div>
                            <?php } ?>
                            ...
                            <i class=" fa fa-question-circle" style="color: <?= env('MAIN_COLOR'); ?>"
                        ...
                        <div class="card-body">
                            <form method="post" id="orderForm">
                                ...
                                <select class="form-control" id="cores" name="cores">
                                    <?php
                                        ...
                                        while ($row = $SQL1->fetch(PDO::FETCH_ASSOC)) {
                                            include BASE_PATH . 'resources/customer/gameserver/option.php';
                                        } ?>
                                </select>
                                ...
                                <span class="badge badge-primary">Nachträglich installierbar</span> Bungeecord,
                                Craftbukkit, Fabric, Forge, Paper, Purpur, Spigot, SpongeVanilla, Tuinity, Vanilla (+
                                Snapshots), Velocity und Waterfall
                                <br>
                                ...
                                <input hidden name="mainrabatt_script" id="mainrabatt_script"
                                       value="<?= $mainrabatt; ?>">
                                ...
                                <label for="agb" class="checkbox noselect">
                                    ...
                                    Ich habe die <a href="<?= $helper->url(); ?>agb">AGB</a> und <a
                                        href="<?= $helper->url(); ?>datenschutz">Datenschutzerklärung</a> gelesen und
                                    akzeptiere diese.
                                </label>
                                <br>
                                <br>
                                <label for="wiederruf" class="checkbox noselect">
                                    ...
                                    <span></span>
                                    Ich wünsche die vollständige Ausführung der Dienstleistung vor Fristablauf des
                                    Widerufsrechts gemäß Fernabsatzgesetz. Die automatische Einrichtung und Erbringung
                                    der Dienstleistung führt zum Erlöschen des Widerrufsrechts.
                                </label>
                    ...
                    <div class="card" style="border-radius: 15px 10px;">
                        ...
                        <div class="card-body">
                            ...
                            <?php if ($user->sessionExists($_COOKIE['session_token'])) { ?>
                                ...
                                <?php if ($order == true) { ?>
                                    <a onclick="orderNow();" id="orderBtn"
                                       class="btn btn-block btn-outline-primary mb-4 pulse-red">
                ...
                <script>
                    ...
                    function update() {
                        ...
                        var calculate = Number((sum + <?= $site->getProductPrice('GAMESERVER_MC'); ?>) * $("#duration").find("option:selected").data("factor")).toFixed(2);
                        var price = Number(calculate).toFixed(2);
                        $("*[data-amount]").html(price + "€");

                        var codeprice = "<?php echo $codeprice; ?>";
                        var mainrabatt = "<?php echo $mainrabatt; ?>";


                        var right = parseFloat((price / 100) * mainrabatt).toFixed(2);
                        var rightnow = Number(price - right).toFixed(2);
                        var price_voucher = Number(price - codeprice).toFixed(2);

                        $("*[data-amount_code]").html(price_voucher + "€");
                        $("*[data-amount_rabatt]").html(rightnow + "€");
