...
include BASE_PATH.'app/controller/PageController.php';
    include BASE_PATH.'app/manager/customer/kvm/order_amd.php';
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="text-center" style="margin-top: 1px; margin-bottom: 30px;">
            <h1 style="font-size: 70px;">Unsere <b style="color: <?= env('MAIN_COLOR'); ?>">AMD KVM</b> Server</h1>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="card" style="border-radius: 15px 10px;">
                        <div class="card-header"><h1>Niederlande, KVM Rootserver</h1>
                    ...
                    <?php } ?>
						...
						<hr>
							...
							<i class="fa fa-microchip" style="color: <?= env('MAIN_COLOR'); ?>"></i>
							  </span> bis zu <b>16</b> AMD Ryzen vKerne (Max. 4,80 Ghz)
							<br>
